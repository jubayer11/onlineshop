                    ...
                    <div class="aa-header-top-area">
                        ...
                        <div class="aa-header-top-right">
                            <ul class="aa-head-top-nav-right">
                                <li><a href="{{route('dailyshop.account')}}">My Account</a></li>
                                <li class="hidden-xs"><a href="{{route('dailyshop.wishlist')}}">Wishlist</a></li>
                                <li class="hidden-xs"><a href="{{route('dailyshop.cart')}}">My Cart</a></li>
                                <li class="hidden-xs"><a href="{{route('dailyshop.checkout')}}">Checkout</a></li>
                    ...
                    <div class="aa-header-bottom-area">
                      ...
                      <span class="aa-cartbox-total-title">
                        ...
                        $500
                                ...
                                <a class="aa-cartbox-checkout aa-primary-btn" href="{{route('dailyshop.checkout')}}">Checkout</a>
                            </div>
                        </div>
                        <!-- / cart box -->
                        <!-- search box -->
            ...
            <div class="navbar navbar-default" role="navigation">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="{{route('dailyshop.index')}}">Home</a></li>
                        ...
                        <li><a href="{{route('dailyshop.blogArchive')}}">Blog <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                        ...
                        <li><a href="#">Pages <span class="caret"></span></a>
                            <ul class="dropdown-menu">
                                <li><a href="{{route('dailyshop.product')}}">Shop Page</a></li>
                                <li><a href="{{route('dailyshop.productDetail')}}">Shop Single</a></li>
                                <li><a href="{{route('dailyshop.nopage')}}">404 Page</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!--/.nav-collapse -->
            ...
            <div class="modal-body">
                ...
                <form class="aa-login-form" action="">
                    ...
                    <div class="aa-register-now">
                        Don't have an account?<a href="{{route('dailyshop.account')}}">Register now!</a>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
