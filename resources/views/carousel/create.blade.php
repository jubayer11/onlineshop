...
@section('content')
    ...
    <div class="container">
        ...
        <div class="panel-body" >
            ...
            <form  class="form-horizontal" action="{{route('carousel.store')}}" method="post" >
                {{csrf_field()}}
                ...
                <div id="div_id_email" class="form-group required">
                    <label for="id_email" class="control-label col-md-4  requiredField"> save<span class="asteriskField">*</span> </label>
                    <div class="controls col-md-8 ">
                        <input class="input-md emailinput form-control" id="id_email" name="save" placeholder="Your current email address" style="margin-bottom: 10px" type="text" />
                    </div>
                </div>
                <div id="div_id_password1" class="form-group required">
                    <label for="id_password1" class="control-label col-md-4  requiredField">Description:<span class="asteriskField">*</span> </label>
                    <div class="controls col-md-8 ">
                        <input class="input-md textinput textInput form-control" id="id_password1" name="body" placeholder="Create a password" style="margin-bottom: 10px" type="text" />
                    </div>
                </div>
