...
@section('content')
    ...
    <div class="container">
        ...
        <a href="{{route('carousel.create')}}">  <button class="punch">Create Carousel</button></a>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">All the Carousel</h3>
                        ...
                        @if($carousel)
                            @foreach($carousel as $car)
                                <tr>
                                    ...
                                    <td><a href="{{route('carousel.edit',$car->id)}}"><button class="btn btn-xs btn-outline-warning">Edit</button></a> </td>

                                    <td>
                                        <form action="{{route('carousel.destroy',['id'=>$car->id])}}" method="post">
                                            {{csrf_field()}}
                                            {{method_field('DELETE')}}
