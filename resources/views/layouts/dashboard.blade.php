...
<head>
    ...
    <link href="{{asset('app/css/light-bootstrap-dashboard.css?v=1.4.0')}}" rel="stylesheet"/>
    ...
    <link href="{{asset('app/css/pe-icon-7-stroke.css')}}" rel="stylesheet" />

</head>
<body>

<div class="wrapper">
    <div class="sidebar" data-color="purple" data-image="{{asset('app/img/sidebar-5.jpg')}}">
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="{{route('super.typography')}}">
                        <i class="pe-7s-news-paper"></i>
                        <p>Typography</p>
                    </a>
                </li>
                <li>
                    <a href="{{route('super.icons')}}">
                        <i class="pe-7s-science"></i>
                        <p>Icons</p>
                    </a>
                </li>
                <li>
                    <a href="{{route('super.maps')}}">
                        <i class="pe-7s-map-marker"></i>
                        <p>Maps</p>
                    </a>
                </li>
                <li>
                    <a href="{{route('super.notifications')}}">
                        <i class="pe-7s-bell"></i>
                        <p>Notifications</p>
                    </a>
                </li>
                <li class="active-pro">
                    <a href="{{route('super.upgrade')}}">
...
<!--  Charts Plugin -->
<script src="{{asset('app/js/chartist.min.js')}}"></script>
...
<script src="{{asset('app/js/light-bootstrap-dashboard.js?v=1.4.0')}}"></script>
