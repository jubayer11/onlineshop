                        ...
                        <div class="aa-product-area">
                            <div class="aa-product-inner">
                                ...
                                <ul class="nav nav-tabs aa-products-tab">
                                    ...
                                    <li class="active"><a href="{{route('dailyshop.index.category',$category->id)}}"><button>{{$category->name}}</button></a></li>
                                    @foreach($categories as $category)
                                    <li><a href="{{route('dailyshop.index.category',$category->id)}}" ><button>{{$category->name}}</button></a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade in active" id="men">
                                        <ul class="aa-product-catg">
                                            ...
                                            <li>
                                                <figure>
                                                    <a class="aa-product-img" href="#"><img src="{{ URL::to('/') }}/uploads/product/{{$product->image ? $product->image->name: 'no carousel photo'}}" alt="polo shirt img"></a>
                                                ...
                                                <div class="aa-product-hvr-content">
                                                    ...
                                                    <a href="{{route('product.quick_view',$product->id)}}" data-toggle2="tooltip" data-placement="top" title="Quick View" data-toggle="modal" data-target="#quick-view-modal"><button><span class="fa fa-search"></span></button></a>
                                                </div>
                                                <!-- product badge -->
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <!-- Modal view content -->
                                                        ...
                                                        @include('onlineshop/product_quick_view');
