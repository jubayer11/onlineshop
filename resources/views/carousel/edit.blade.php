            ...
            <div class="panel-body" >
                ...
                <form  class="form-horizontal" action="{{route('carousel.update',['id'=>$carousel->id])}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div id="div_id_email" class="form-group required">
                        ...
                        <div class="controls col-md-8 ">
                            <input class="input-md emailinput form-control" id="id_email" name="save" value="{{$carousel->save}}" placeholder="Your current email address" style="margin-bottom: 10px" type="text" />
                        </div>
                    </div>
                    <div id="div_id_password1" class="form-group required">
                        ...
                        <div class="controls col-md-8 ">
                            <input class="input-md textinput textInput form-control" id="id_password1" name="body" value="{{$carousel->body}}" placeholder="Create a password" style="margin-bottom: 10px" type="text" />
                        </div>
                    </div>
