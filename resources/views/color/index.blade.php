                ...
                <form  class="form-horizontal" action="{{route('color.store')}}" method="post" >
                    ...
                    <div id="div_id_username" class="form-group required">
                        ...
                        <div class="controls col-md-8 ">
                            <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="name" placeholder="create a Color for this Product" style="margin-bottom: 10px" type="text" />
                        </div>
                    </div>
                    ...
                    @if($colors)
                        @foreach($colors as $color)
                            <tr>
                                ...
                                <td><a href="{{route('color.edit',$color->id)}}"><button class="btn btn-xs btn-primary">Edit</button></a> </td>
